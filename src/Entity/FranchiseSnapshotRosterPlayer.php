...
/**
 * @ORM\Entity(repositoryClass="App\Repository\FranchiseSnapshotRosterPlayerRepository")
 */
class FranchiseSnapshotRosterPlayer
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\FranchiseSnapshot", inversedBy="roster")
     * @ORM\JoinColumn(nullable=false)
     */
    private $snapshot;
